...
class Twitter_Element(Element):
    ...
    def __init__(self, username):
        ...
        super(Twitter_Element, self).__init__(filename=self.profile_photo)
    ...
    def tile_photo(self, profile_photo):
        i_file = Image.open(profile_photo)
        ...
        tile_filename = str(uuid.uuid4())+'.jpg'
        canvas.save(tile_filename)
